...
Site: allwayswireless.com · Priority 1 · Medium · Effort: Medium (2-5 days)

## Problem
4 of 6 standard security headers are absent, which weakens protection against XSS, clickjacking and downgrade attacks.

## Evidence (from the live site)
> Measured on the live origin: missing CSP, X-Frame-Options, Referrer-Policy, Permissions-Policy.

## Current state
notes: missing: CSP, X-Frame-Options, Referrer-Policy, Permissions-Policy
