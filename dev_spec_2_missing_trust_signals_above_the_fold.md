...
Site: allwayswireless.com · Priority 2 · High · Effort: Medium (2-5 days)
...
> Measured on the live homepage: no match for returns policy, guarantee, reviews.

## Current state
notes: absent: returns policy, guarantee, reviews
